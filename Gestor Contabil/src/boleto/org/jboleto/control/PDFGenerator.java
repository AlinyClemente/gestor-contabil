...
package boleto.org.jboleto.control;
...
public class PDFGenerator implements Generator {
    ...
    public PDFGenerator(JBoletoBean boleto, int codBanco) {
        ...
        try {
            ...
            imgTitulo = Image.getInstance(getClass().getResource("/boleto/img/template.gif"));
            ...
            if (boleto.getImagemMarketing() != null) {
                ...
                imgMarketing = Image.getInstance(getClass().getResource("/boleto/img/pixel.gif"));
            }
    ...
    public void addBoleto(JBoletoBean boleto, Banco banco) {
        ...
        try {
            ...
            imgBanco = Image.getInstance(getClass().getResource("/boleto/img/" + Integer.parseInt(banco.getNumero()) + ".gif"));
